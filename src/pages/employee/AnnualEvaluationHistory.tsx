...
export default function AnnualEvaluationHistory() {
        ...
        <div className="space-y-6">
          ...
          <Alert className="border-orange-200 bg-orange-50">
            ...
            <AlertDescription className="text-orange-700">
              Anda belum menghantar penilaian kendiri.{' '}
              <Button
                variant="link"
                className="p-0 h-auto text-orange-700 font-semibold"
                onClick={() => navigate(`/dashboard/my-annual-evaluation/${(evaluation.cycle as any)?.id}/submit`)}
              >
                Hantar sekarang →
              </Button>
            </AlertDescription>
  ...
  return (
    <EmployeeLayout>
      <div className="space-y-6">
        ...
        {/* Spider Chart - only show if supervisor has evaluated */}
        {hasSupervisorAnswers && (
          <Card>
            <CardHeader>
